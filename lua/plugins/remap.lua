        ...
        config = function()
            ...
            require("which-key").register({
                ...
                f = {
                    ...
                    r = { "<cmd>lua require'telescope.builtin'.oldfiles({cwd_only=true})<CR>",
                        "find recent file cwd only" },
            ...
            require("which-key").register({
                ...
                z = {
                    ...
                    n = { function()
                        ...
                        local language
                        local title
                        function CompleteCategoryList()
                            return { "project", "area", "resource", "inbox" }
                        end

                        function CompleteLanguageList()
                            return { "cn", "en" }
                        end

                        vim.ui.input(
                        { prompt = "Category: ", default = "inbox", completion = "customlist,v:lua.CompleteCategoryList" },
                            function(input)
                                category = input
                            end)
                        vim.ui.input(
                        { prompt = "Language: ", default = "cn", completion = "customlist,v:lua.CompleteLanguageList" },
                            function(input)
                                language = input
                            end)
                        ...
                        local group = category .. "/" .. language
                        require("zk").new({ group = group, title = title })
                    end, "create note" },
                    f = { function ()
                        require("zk").edit()
                    end, "find note"}
