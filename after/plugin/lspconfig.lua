local exist, nvim_lsp = pcall(require, "lspconfig")
if (not exist) then return end

local protocol = require'vim.lsp.protocol'
local lspsaga_exit, _ = pcall(require, "lspsaga")
...
local on_attach = function(client, bufnr)
  ...
  -- Use functions provided by lspcofig if lspsaga not installed
  if (not lspsaga_exit) then
